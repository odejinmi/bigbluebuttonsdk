...
class Websocket extends GetxController {
  ...
  set recordingtime(seconds) {
    ...
    _recordingtime.value =
        '${_twoDigitString(hours)}:${_twoDigitString(minutes)}:${_twoDigitString(remainingSeconds)}';
  }
    ...
    channel!.stream.listen(
      (event) async {
        if (!isWebsocketRunning) {
          ...
          var sturnserv = await Diorequest().get(
  ...
  Map<String, dynamic> replacePasswordWithCredential(
        ...
        return MapEntry(
            ...
            value.map((e) {
              return e is Map<String, dynamic>
                  ? replacePasswordWithCredential(e)
                  : e;
            }).toList());
      }
  ...
  mainsub(String type) {
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"sCChYLTr2PwGBoCTz\",\"name\":\"meteor_autoupdate_clientVersions\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"Rxc87B5BHrDo4teDB\",\"name\":\"auth-token-validation\",\"params\":[{\"meetingId\":\"${meetingdetails.meetingId}\",\"userId\":\"${meetingdetails.internalUserId}\"}]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"GrzXtmmd2xZMqQHiq\",\"name\":\"current-user\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"dniJfvPpCcxQ2qm4f\",\"name\":\"users\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"KYE6a3qd4tNwNjoND\",\"name\":\"meetings\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"7zejoYww9GPhtLJxQ\",\"name\":\"polls\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"8F6XpqQBwDrAHBGtL\",\"name\":\"presentations\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"g2QE6xhHM6S8Xp7Q4\",\"name\":\"slides\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"N8sMPgHmLTXvYPxdb\",\"name\":\"slide-positions\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"WGaXxbjrefCNF8aoR\",\"name\":\"captions\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"efTZ2HZ34fyH7A4m2\",\"name\":\"voiceUsers\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"7F9qjiRxZuq8s2jww\",\"name\":\"whiteboard-multi-user\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"C92qF3DSQuJPQ3Khz\",\"name\":\"screenshare\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"ARXr9XG7ivFzNciZH\",\"name\":\"group-chat\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"MrdTEYjGj47B3hP7h\",\"name\":\"presentation-pods\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"ZGnLqQf6qf9fagxGt\",\"name\":\"users-settings\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"xh7BMxu2PzaYDZNA8\",\"name\":\"guestUser\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"GcsEudeq3REZ52nvR\",\"name\":\"users-infos\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"jXzXfsXwuT4vqnCMQ\",\"name\":\"note\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"upFmPa7LviR28pgKB\",\"name\":\"meeting-time-remaining\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"HXMqjHdZbXx58evdQ\",\"name\":\"local-settings\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"TNqZwbhwvGiv2Hxjx\",\"name\":\"users-typing\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"QmD2NHcomy27LHDyc\",\"name\":\"record-meetings\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"BMSzYbfFBisY85hRw\",\"name\":\"video-streams\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"pKjwX5n9ospfwXRro\",\"name\":\"connection-status\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"rxffSQazoac8tyjC9\",\"name\":\"voice-call-states\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"6qjAGwkRWDMtLBHFz\",\"name\":\"external-video-meetings\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"HKaQ8RWYqdbyaNNeN\",\"name\":\"meetings\",\"params\":[\"MODERATOR\"]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"7nZPTNKSNnsZQCAtR\",\"name\":\"users\",\"params\":[\"MODERATOR\"]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"Xzp9p44xtpwAoytmN\",\"name\":\"breakouts\",\"params\":[\"MODERATOR\"]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"SBKGrLuT7mnxvzn2J\",\"name\":\"guestUser\",\"params\":[\"MODERATOR\"]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"9JufFR8xgDgMeAQtL\",\"name\":\"annotations\",\"params\":[]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"wJGKEXoZ5NuDeNfp6\",\"name\":\"stream-cursor-8d507a70979aefb79db859b2d8cdea86c19ee151-1684392490996\",\"params\":[\"message\",{\"useCollection\":false,\"args\":[]}]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"d9gbwCg7yFx4NzbpY\",\"name\":\"stream-annotations-8d507a70979aefb79db859b2d8cdea86c19ee151-1684392490996\",\"params\":[\"removed\",{\"useCollection\":false,\"args\":[]}]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"h3WDbaWpAtgqSj5zB\",\"name\":\"stream-annotations-8d507a70979aefb79db859b2d8cdea86c19ee151-1684392490996\",\"params\":[\"added\",{\"useCollection\":false,\"args\":[]}]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"x4Snpk6xctKC23hPc\",\"name\":\"group-chat-msg\",\"params\":[[]]}"
    ]);
    websocketsub([
      "{\"msg\":\"$type\",\"id\":\"azHBtJorAvXd6FiBq\",\"name\":\"users-persistent-data\",\"params\":[]}"
    ]);
  }
